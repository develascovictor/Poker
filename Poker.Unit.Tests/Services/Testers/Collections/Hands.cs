...
namespace Poker.Unit.Tests.Services.Testers.Collections
{
    public static class Hands
    {
        ...
        {
            public static Hand Sixteen => new Hand
            (
                new List<Card>
                {
                    Cards.Heart8,
            ...
            public static Hand TwentyFour => new Hand
            (
                new List<Card>
                {
                    Cards.Spade5,
            ...
            public static Hand TwentyTwo => new Hand
            (
                new List<Card>
                {
                    Cards.ClubAce,
            ...
            public static Hand Twenty => new Hand
            (
                new List<Card>
                {
                    Cards.DiamondKing,
            ...
            public static Hand Seventeen1 => new Hand
            (
                new List<Card>
                {
                    Cards.Club4,
            ...
            public static Hand Seventeen2 => new Hand
            (
                new List<Card>
                {
                    Cards.SpadeJack,
